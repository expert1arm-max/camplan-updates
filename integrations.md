...
- Current packaged installer version is `0.2.9`.
...
- The downloaded installer is launched through Electron `shell.openPath(...)` so quitting the app does not terminate the installer midway through setup.
