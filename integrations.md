...
- Current packaged installer version is `0.2.5`.
...
- The downloaded installer is launched as a detached Windows process so quitting the app does not terminate the installer midway through setup.
