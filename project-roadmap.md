...
- Проверить старт приложения без demo data: восстановление snapshot из IndexedDB, fallback active refs и empty-state на пустом проекте.
...
- Проверить свежий portable EXE `release\CCTV Manager 0.1.0.exe` на запуск и отображение стилей.
...
Провести ручную проверку свежего portable EXE по `qa-checklist.md`:
...
## Сейчас
- Проверить свежий portable EXE `release\CCTV Manager 0.1.0.exe` на множественное выделение, раскрывающийся список в правой панели и группировку объектов.
...
- Провести ручную QA-проверку свежего portable EXE по обновлённому сценарию multi-select/grouping и затем исправить найденные UX/логические ошибки.
