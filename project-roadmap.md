...
- Проверить свежий Windows installer `release\CamPlan Setup 0.2.15.exe` на запуск, отображение стилей и update-launch логирование.
...
## Сейчас
- Проверить свежий Windows installer `release\CamPlan Setup 0.2.15.exe` на множественное выделение, раскрывающийся список в правой панели и группировку объектов.
...
- Проверить локально собранный Windows installer `release\CamPlan Setup 0.2.15.exe` на ручной сценарий обновления перед публикацией релиза.
- Проверить, что update-install logging фиксирует путь установщика, факт существования файла, путь launcher `.cmd` и выбранный метод запуска.
