...
- Проверить свежий Windows installer `release\CCTV Manager Setup 0.2.6.exe` на запуск и отображение стилей.
...
## Сейчас
- Проверить свежий Windows installer `release\CCTV Manager Setup 0.2.6.exe` на множественное выделение, раскрывающийся список в правой панели и группировку объектов.
