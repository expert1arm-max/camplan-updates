...
- Версия приложения поднята до `0.1.2`; локальный Windows installer `release\CCTV Manager Setup 0.1.2.exe` собран, а тег `v0.1.2` отправлен в GitHub для публикации релиза через Actions.
...
- 22.05.2026 `npm run dist:win` успешно собрал Windows installer `release\CCTV Manager Setup 0.1.2.exe`.
