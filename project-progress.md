...
- Версия приложения поднята до `0.2.24`; локальный Windows installer `release\CamPlan-Installer-0.2.24.exe` собран для ручного теста update flow перед публикацией релиза.
