...
- Версия приложения поднята до `0.2.3`; локальный Windows installer `release\CCTV Manager Setup 0.2.3.exe` собран, а тег `v0.2.3` отправлен в GitHub для публикации релиза через Actions.
