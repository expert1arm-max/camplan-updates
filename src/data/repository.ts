...
function normalizeObject(input: unknown): SiteObject {
  ...
  return {
    ...
    name: asString(record.name, "РќРѕРІС‹Р№ РѕР±СЉРµРєС‚"),
    description:
...
function normalizeFloor(input: unknown, index: number): Floor {
  ...
  return {
    ...
    name: asString(record.name, "РќРѕРІР°СЏ Р·РѕРЅР°"),
...
function normalizeDevice(input: unknown): Device {
  ...
  return {
    ...
    type,
    name: asString(record.name, type === "camera" ? "РќРѕРІР°СЏ РєР°РјРµСЂР°" : "РќРѕРІРѕРµ СѓСЃС‚СЂРѕР№СЃС‚РІРѕ"),
